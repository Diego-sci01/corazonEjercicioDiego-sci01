...
const printByChart = (ms) => {
  let delay = 0;
  for(const linea of asciiHeart){
    for (const caracter of linea){
        setTimeout(()=> process.stdout.write(caracter),delay);
        delay += ms;
    }
...
//Una esta comentada porque no funcionan correctamente cuando se ejecutan ambas al mismo tiempo.
 printByChart(100);
// printByLine(1000);
